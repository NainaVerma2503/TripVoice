#!/usr/bin/env python3
"""
Test script to demonstrate the API with rich mock data
"""
...
def test_mock_api():
    ...
    print("🚀 Testing Search API with Rich Mock Data")
    print("=" * 60)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("💾 Full response saved to 'mock_response.json'")
            
            # Show sample JSON structure
            print("\n📋 Sample JSON Structure:")
            print("-" * 30)
            sample_response = {
                "flights": flights[:2],  # Show first 2 flights
                "hotels": hotels[:2],    # Show first 2 hotels
